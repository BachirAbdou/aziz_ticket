...
import 'package:aziz/constants/dimens.dart';
import 'package:aziz/generated/l10n.dart';
import 'package:aziz/theme/theme_extensions/app_button_theme.dart';
import 'package:aziz/theme/theme_extensions/app_color_scheme.dart';
import 'package:aziz/views/widgets/card_elements.dart';
import 'package:aziz/views/widgets/portal_master_layout/portal_master_layout.dart';
import 'package:aziz/views/widgets/url_new_tab_launcher.dart';
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: FormBuilderCheckboxGroup(
                                        ...
                                        options: const [
                                          FormBuilderFieldOption(value: 'Aziz 1', child: Text('Aziz 1')),
                                          FormBuilderFieldOption(value: 'Moussa 2', child: Text('Moussa 2')),
                                          FormBuilderFieldOption(value: 'Bachir 3', child: Text('Bachir 3')),
                                          FormBuilderFieldOption(value: 'Traoré 4', child: Text('Traoré 4')),
                                          FormBuilderFieldOption(value: 'Bertrand 5', child: Text('Bertrand 5')),
                                        ],
                                      ),
                                    ),
